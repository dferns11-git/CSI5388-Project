...
y_test_f = multiclass_test[" Label"].copy()
X_test_f = multiclass_test.drop([" Label"], axis=1)
            ...
            for feature_key, feature_val in feature_set.items():
                ...
                for score_method in score_methods:
                    ...
                    for future in as_completed(futures):
                        ...
                        params.append((f"Multiclass {name} {feature_key} {score_method} Fold {counter}", f1, best_param))
